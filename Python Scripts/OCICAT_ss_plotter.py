...
p_string =r"J:\joslaton\WOLF\AZTEC_ES5\S-Parameters"
output_path = r"J:\joslaton\WOLF\AZTEC_ES5\S-Parameters\ALL"
...
nominal = [rec for rec in a if all([rec.serial!='SN4',rec.serial!='SN5',rec.temperature==rev_tdict[1],rec.voltage==rev_vdict[1]])]
wc = [rec for rec in a if all([rec.serial!='SN4',rec.serial!='SN5',rec.temperature==rev_tdict[2],rec.voltage==rev_vdict[0]])]
